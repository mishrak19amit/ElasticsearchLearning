...
public class PartialUpdateApplication {
	...
	private static final String INDEX = "product_v3";
	...
	private static void PartialUpdateDemo() {
		UpdateByQueryRequestBuilder updateByQuery =
				// new UpdateByQueryRequestBuilder(restHighLevelClient,
				// UpdateByQueryAction.INSTANCE);
				UpdateByQueryAction.INSTANCE.newRequestBuilder((ElasticsearchClient) restHighLevelClient);
		updateByQuery.source("product_v3").filter(QueryBuilders.termQuery("moglixPartNumber", "MSN2QRDGDL0CFL"))
				.size(1000).script(new Script(ScriptType.INLINE, "ctx._source.awesome = 'absolutely'", "painless",
	...
	private static void updateDemo() throws IOException {
		UpdateRequest request = new UpdateRequest("product_v3", "_doc", "MSN2QRDGDL0CFL");
		Map<String, Object> parameters = Collections.singletonMap("title", "c++ programing.");
