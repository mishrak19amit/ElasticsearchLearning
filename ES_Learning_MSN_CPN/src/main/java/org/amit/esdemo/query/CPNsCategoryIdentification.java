...
public class CPNsCategoryIdentification {
	...
	public static void main(String[] args) {
		...
		LinkedHashMap<String,LinkedHashMap<String, String>> cpnMap = XlxsFileReaderUtil.cpnListFromXlxsFile("/home/moglix/Desktop/CPN_MSN_Mapping/CPNsIdentifiedCategory.xlsx");
